...
public class userProfileServiceProvider {
	...
	public String newProfile(
			...
			@FormParam("curPosition") String curPosition,
		...
		if (curPosition !=null){
			userProfile.setCurPosition(curPosition);
		}
		if (education !=null){
...
//		
		return userProfileImpl.createProfile(userProfile);
	...
	public Response createProfile(userProfileBean profile)
			throws Exception {
