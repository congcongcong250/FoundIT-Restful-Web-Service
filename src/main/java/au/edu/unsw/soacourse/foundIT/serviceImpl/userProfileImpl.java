...
public class userProfileImpl implements userProfileService {
	...
	public userProfileBean getSpecificProfile(String id) {
		...
		resultBean.setFullname(element.getElementsByTagName("fullname").item(0).getTextContent());
		resultBean.setCurPosition(element.getElementsByTagName("curPosition").item(0).getTextContent());
		resultBean.setEducation(element.getElementsByTagName("education").item(0).getTextContent());
