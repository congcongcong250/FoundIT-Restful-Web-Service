	...
	public companyProfileBean getSpecificProfile(String id) {
		...
		if (flag) {
			...
			resultBean.setPhone(element.getElementsByTagName("phone").item(0)
					.getTextContent());
			resultBean.setHeadQuarterAdd(element.getElementsByTagName("headQuarterAdd").item(0)
					.getTextContent());
			resultBean.setIndustryType(element.getElementsByTagName("industryType").item(0)
					.getTextContent());
			resultBean.setWebSite(element.getElementsByTagName("webSite").item(0)
					.getTextContent());
